...
class FirstInterviewDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how first interviews are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(first_interview)
  #   "FirstInterview ##{first_interview.id}"
  # end
end
